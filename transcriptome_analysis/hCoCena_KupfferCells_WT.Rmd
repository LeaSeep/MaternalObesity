...
universe_entrez <- clusterProfiler::bitr(all_genes, 
                        fromType="ENSEMBL",
                        toType="ENTREZID",
...
```{r}
selectedPathways <- c("OXIDATIVE_PHOSPHORYLATION","GLYCOLYSIS","HYPOXIA","NoraSet")

selectedPathways <- c("HALLMARK_INFLAMMATORY_RESPONSE")
...
for(i in selectedPathways){
 ...
 # union_selected <- ORA_cluster_results$steelblue$GeneSet
  ...
  print(paste0("Hif1a in data: ", hifa %in% allTermAssocGenesKEGG ))
  print(paste0("Hif1a in data: ", hifa %in% allTermAssocGenesHallmark ))

  print(paste0("Hif1a in data: ", hifa %in% union_selected))
