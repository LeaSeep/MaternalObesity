...
CoCena_Input_HC <- readRDS("../data/CoCena_Input_KC.rds")
...
set_layer_settings(top_var = 6683,
...
```
  ...
  2 - determine range of +-20% [891 - 593]
  3 - within determined range select highest Rsquared ( here 0.531)
  

```{r choose cutoff}
set_cutoff(cutoff_vector = c(0.897))
